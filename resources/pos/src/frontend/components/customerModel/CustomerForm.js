...
const CustomerForm = ( props ) => {
    ...
    ruc: singleCustomer ? singleCustomer[0].ruc || '' : ''
    } );
                        ...
                        <div className='card-body'>
                            <Form>
                                <div className='row'>
                                    ...
                                    <div className='col-md-6 mb-3'>
    <label className='form-label'>Número RUC:</label>
    <span className='required' />
    <input
        type='text'
        name='ruc'
        className='form-control'
        placeholder='Ingrese el número RUC'
        value={customerValue.ruc}
        onChange={(e) => onChangeInput(e)}
    />
    <span className='text-danger d-block fw-400 fs-small mt-2'>
        {errors['ruc'] ? errors['ruc'] : null}
    </span>
</div>
